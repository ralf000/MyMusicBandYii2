...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . end(explode('.', $_SERVER['HTTP_HOST'])),
	...
	*/
	...
	'access_keys' => array('28wUn9572EX6m4wVkdJd'),
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( '../../../../frontend/web/upload/filemanager/web' ), //fixed path of the image folder from the current position on upload folder
	...
	'fixed_image_creation_width'              => array(500), //width of image (you can leave empty if you set height)
